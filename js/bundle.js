    ...
    function getDinamicInformation (selector) {
        ...
        input.addEventListener('input', () => {
            ...
            if (input.value.match(/\D/g)) {
                input.style.cssText = 'box-shadow: 0 4px 15px rgb(200 0 0 / 40%);';
            } else {
                input.style.cssText = '';
            }  
...
function forms (formSelector, modalTimerId) {
    ...
    function bindPostData(form) {
        form.addEventListener('submit', (e) => {
            ...
            const res = JSON.stringify(Object.fromEntries(formData.entries()));

            (0,_services_services__WEBPACK_IMPORTED_MODULE_1__.postData)('http://localhost:3000/requests', res)
            .then(data => {
                console.log(data);
